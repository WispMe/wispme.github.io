                ...
                <Fade>
                    <div className="container">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            ...
                            <div className="contact-content"><a href="https://www.linkedin.com/in/faiz-adil-khatami-2179a6158/"><img src={linkedin} alt="LinkedIn" width="28" height="28" /></a></div>
                            ...
                            <div className="contact-content"><a href="https://github.com/faizfak/"><img src={github} alt="Github" width="28" height="28" /></a></div>
